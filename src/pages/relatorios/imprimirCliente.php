...
$cliente = mysqli_query($conexao, "SELECT clienteEntrega,celularEntrega,bairroEntrega,enderecoEntrega,numeroEntrega,taxaEntrega,cartaoEntrega,dinheiroEntrega,pixEntrega,descontoEntrega,totalEntrega,dataEntrega, horaEntrega FROM entregas WHERE idEntrega ='$idEntrega'");
...
FROM entregas_concluida WHERE idEntrega ='$idEntrega'");
...
$body3 = '
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <td style="font-weight: bold;">R$ ' . number_format($cliente['totalEntrega'] + $cliente['descontoEntrega'] - $cliente['taxaEntrega'], 2, ", ", " . ")  . '</td>
                    </tr>
                    <tr>
                        <th>DESC</th>
                        <th></th>
                        <th></th>
                        <td style="font-weight: bold;">R$ ' . number_format($cliente['descontoEntrega'], 2, ", ", " . ") . '</td>
                    </tr>
                    <tr>
                    <th>TAXA</th>
                    <th></th>
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <td style="font-weight: bold;">R$ ' . number_format($cliente['totalEntrega'], 2, ", ", " . ") . '</td>
                    </tr>
                </tfoot>
            </table>
            <hr>
...
';
if ($cliente['cartaoEntrega'] == '0.00') {
    $body4 = "<p>Pix - R$ " . $cliente['pixEntrega'] . "</p>
    <p>Dinheiro - R$ " . $cliente['dinheiroEntrega'] . "<p/>
    </main>
</body>";
} elseif ($cliente['pixEntrega'] == '0.00') {
    $body4 = "<p>Cartao - R$ " . $cliente['cartaoEntrega'] . "</p>
    <p>Dinheiro - R$ " . $cliente['dinheiroEntrega'] . "</p>
    </main>
</body>";
} elseif ($cliente['dinheiroEntrega'] == '0.00') {
    $body4 = "<p>Cartao - R$ " . $cliente['cartaoEntrega'] . "</p>
    <p>Pix - R$ " . $cliente['pixEntrega'] . "</p>
    </main>
</body>";
} else {
    $body4 = "<p>Cartao - R$ " . $cliente['cartaoEntrega'] . "</p>
